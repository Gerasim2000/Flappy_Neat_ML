...
class DoomWrapper(object):
    ...
    def __init__(self, width, height, cfg_file, scenario_file):
        ...
        vizdoom_dir = os.path.join("C:\\", "Users", "Bazinga", "AppData", "Local", "Programs", "Python", "Python39", "Lib", "site-packages", "vizdoom")
        ...
        self.vizdoom_file = (os.path.join(vizdoom_dir, "vizdoom"))        
        self.freedom_file = (os.path.join(vizdoom_dir, 'freedoom2.wad'))
        self.scenario_file = (os.path.join(vizdoom_dir, 'scenarios', scenario_file))
    ...
    def getScreenRGB(self):
        return self.state.screen_buffer.copy()
